...
bgmask_container.innerHTML = '<div id="bcq_posemask" style="position:absolute;left:0px;top:0px;height:100%;width:100%;background:rgba(50,50,50,0.7);z-index:10000;display:none;"><div id="bcq_poseform" style="border-radius: 25px; z-index: 10000; top: 0; left: 0; right: 0; bottom: 0; width:60%; height:60%; max-height:275px; max-width:650px; min-width:100px; margin:auto; background: none repeat scroll 0% 0% rgb(250, 250, 250); border: 10px solid rgb(40, 40, 40); padding: 50px; position: absolute; min-height: 180px"><form onsubmit="return false;" style="height:90%"><p>Ask a question about <i id="bcq_posebookname">' + getBookName() + '</i>.</p><textarea id="bcq_qsubmitinput" placeholder="Type your question here" name="question-title" style="width:90%; min-height:100px; height:70%; display:block; margin:auto;"></textarea><p id="bcq_ermsgpose" class="bcq_ermsg" style="display:none;">Question cannot be blank</p><div style="margin:5px auto;text-align:center;"><button id="bcq_posecancelbutton" type="button" class-"bcq-ui-button">Cancel</button><button id="bcq_posesubmitbutton" type="submit" name="submit">Save</button></div><form></div></div>';
